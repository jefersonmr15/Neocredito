...
WebUI.setText(findTestObject('Cliente/RegistroPersonaJuridica/RazonsocialInput'), findTestData(DataFile).getValue(
        campo[0], fila))

WebUI.setText(findTestObject('Cliente/RegistroPersonaNatural/NumeroDocumentoInput'), findTestData(DataFile).getValue(
        campo[1], fila))

WebUI.setText(findTestObject('Cliente/RegistroPersonaJuridica/DVInput'), findTestData(DataFile).getValue(
        campo[2], fila))
...
WebUI.setText(findTestObject('Cliente/RegistroPersonaJuridica/NumeroDocumentoInput'), findTestData(DataFile).getValue(
        campo[12], fila))
